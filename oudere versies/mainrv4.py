    ...
    <div class="main-grid">
        ...
        <script>
            ...
            function renderFromCoords(seq, coords){
                ...
                if(gc < 40){
                    insights.push("⚠ Low GC content may reduce stability");
                }
                ...
                if(seq.length > 50){
                    insights.push("✓ Larger RNA sequence with potential complex folding");
                }

                if(pairs.length === 0){
                    insights.push("⚠ No significant pairing detected");
                }
